...
$ref_files{$key} = "$dir".q|GUI_auto_analysis.html|; 
$noresave{$key} = "$nosave";
...
$key = q/eq:_quadric/;
$ref_files{$key} = "$dir".q|diffusion_tensor.html|; 
$noresave{$key} = "$nosave";
...
$ref_files{$key} = "$dir".q|Initialisation_data_pipe.html|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:_NOE_plot/;
$ref_files{$key} = "$dir".q|Viewing_results.html|; 
$noresave{$key} = "$nosave";
...
$ref_files{$key} = "$dir".q|Values_gradients_Hessians.html|; 
$noresave{$key} = "$nosave";

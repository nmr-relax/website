...
redirects += [
    ...
    ['manual/Consistency_testing_script_mode_visualisation_data_output.html', '%s/manual/Consistency_testing_script_mode_visualisation_and_data_output.html'%url],
    ...
    ['manual/Introduction_multi_processor.html', '%s/manual/Introduction_to_the_multi_processor.html'%url],
